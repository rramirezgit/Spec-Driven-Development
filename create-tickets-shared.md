...
| `## Step 4: Redactar en __SDD_IDIOMA_TICKETS__` | Template Story (Como/Quiero/Para, Criterios de aceptación, Detalle técnico, DoD) + Template Sub-task. | **Idéntico byte-por-byte.** |
